...
import TableAdminSubjectNo from "../Tools/ToolsAdminSubjectNo";
function AppAdminSubjectNo(){
    const { id } = useParams(); 
        ...
        <main>
            <div className='box-content'>
                ...
                <div className={StartError === 2 ?'box-content-view':'box-content-view none'}>
                    <div className='bx-topic light'>
                        <p><Link to="Admin/AdminSubject">จัดการรายวิชา</Link> / <Link to="/Admin/AdminSubject">รายวิชาทั้งหมด</Link> / {SubjectName}</p>
                    ...
                    <div className='bx-details light'>
                        ...
                        <div>
                            <TableAdminSubjectNo columns={columns}/>
                        </div>
                    </div>
                </div>
            </div>
...
export default AppAdminSubjectNo;